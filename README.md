...
TODO:REBUILD WITH FOUR PARAGRAPHS. 
...
```
reckoning/            The intellectual reckoning — charts, doubts, and horizon
  TRAVERSE.md           Reading guide and intellectual arc
  DISTANT-SHORES.md     Six-step roadmap toward the computational ruler
  DANGEROUS-SHOALS.md   Where the rocks are between Steps 5 and 6
