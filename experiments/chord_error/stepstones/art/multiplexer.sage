...
Run:  ./sagew experiments/chord_error/stepstones/art/multiplexer.sage
"""
...
_here = os.path.dirname(os.path.abspath(
    pathing('experiments', 'chord_error', 'stepstones', 'art', 'multiplexer.sage')))
...
def make_zoo():
    ...
    fig, axes = plt.subplots(_n_rows, _n_cols,
                             figsize=(4.0 * _n_cols, 3.0 * _n_rows),
