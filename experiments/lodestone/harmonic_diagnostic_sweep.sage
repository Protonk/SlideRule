...
Outputs to: experiments/lodestone/results/harmonic_diagnostic_2026-03-12/
  summary.csv   — one row per case (with source_run column)
  percell.csv   — one row per cell per case
  README.md     — manifest

Run from project root:  ./sagew experiments/lodestone/harmonic_diagnostic_sweep.sage
"""
...
def main():
    run_dir = pathing('experiments', 'lodestone', 'results',
                       'harmonic_diagnostic_2026-03-12')
    l1c_dir = pathing('experiments', 'lodestone', 'results', 'l1c_grid_2026-03-12')
