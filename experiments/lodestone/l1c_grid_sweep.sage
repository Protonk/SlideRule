...
Outputs to: experiments/lodestone/results/l1c_grid_2026-03-12/
  summary.csv   — one row per case
  percell.csv   — one row per cell per case

Run from project root:  ./sagew experiments/lodestone/l1c_grid_sweep.sage
"""
...
def main():
    run_dir = pathing('experiments', 'lodestone', 'results', 'l1c_grid_2026-03-12')
    summary_rows = []
    percell_rows = []
