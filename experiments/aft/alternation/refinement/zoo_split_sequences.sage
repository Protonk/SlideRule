...
Run:  ./sagew experiments/aft/alternation/refinement/zoo_split_sequences.sage
"""
...
RESULTS_DIR = pathing('experiments', 'aft', 'alternation', 'refinement', 'results')
CSV_PATH = os.path.join(RESULTS_DIR, 'zoo_split_sequences.csv')
WORKER_SCRIPT = pathing('experiments', 'aft', 'alternation', 'refinement',
                         'zoo_worker.sage')
SAGEW = pathing('sagew')
