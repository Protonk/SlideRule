...
Run:  ./sagew experiments/aft/stepstone/profiles/cartesean_envelope.sage
"""
...
def make_plot():
    ...
    zoo_label_edges(axes, ylabel='per-cell error', xlabel='$m$')
    ...
    out_path = 'experiments/aft/stepstone/profiles/results/cartesean_envelope.png'
