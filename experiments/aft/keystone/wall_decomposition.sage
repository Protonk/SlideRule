...
Run:  ./sagew experiments/aft/keystone/wall_decomposition.sage
"""
...
EXPONENT = '1/2'
OUT_PATH = pathing('experiments', 'aft', 'keystone', 'results', 'wall_decomposition.png')
...
def load_summary(run_tags):
    ...
    seen = set()
    for tag in run_tags:
        path = pathing('experiments', 'aft', 'keystone', 'results', tag, 'summary.csv')
