...
Run:  ./sagew experiments/aft/keystone/intercept_displacement.sage
"""
...
EXPONENT = '1/2'
KIND = 'geometric_x'
OUT_PATH = pathing('experiments', 'aft', 'keystone', 'results', 'intercept_displacement.png')


# ── Load ─────────────────────────────────────────────────────────────

def load_percell(run_tag):
    path = pathing('experiments', 'aft', 'keystone', 'results', run_tag, 'percell.csv')
