...
Run:  ./sagew experiments/aft/keystone/gap_surface.sage
"""
...
OUT_PATH = pathing('experiments', 'aft', 'keystone', 'results', 'gap_surface.png')


# ── Load ─────────────────────────────────────────────────────────────

def load_summary(run_tag):
    path = pathing('experiments', 'aft', 'keystone', 'results', run_tag, 'summary.csv')
