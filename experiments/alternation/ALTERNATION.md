...
(`experiments/keystone/results/wall_surface_2026-03-18/percell.csv`) and
...
Run any of them with `./sagew experiments/alternation/<script>`.
...
Run the zoo sweep: `./sagew experiments/alternation/refinement/zoo_split_sequences.sage`
