...
Run from project root:  ./sagew experiments/h1_sweep.sage
"""
...
def main():
    ...
    write_csv(h1b_rows, os.path.join(results_dir, 'h1b_depth_scaling.csv'))
    ...
    write_csv(h1a_rows, os.path.join(results_dir, 'h1a_gap_vs_q.csv'))
    ...
    write_csv(h1c_rows, os.path.join(results_dir, 'h1c_layer_dependent.csv'))
