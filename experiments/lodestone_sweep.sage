...
Outputs:
  experiments/results/lodestone_summary.csv   — one row per case
  experiments/results/lodestone_percell.csv   — one row per cell per case

Run from project root:  ./sagew experiments/lodestone_sweep.sage
"""
